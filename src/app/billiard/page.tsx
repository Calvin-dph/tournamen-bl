        ...
        <div className="p-5 bg-gradient-to-b from-[#2d3748] to-[#1a2332]">
          ...
          <div className="bg-gradient-to-br from-[#2d3748]/80 to-[#1a2332]/60 rounded-2xl p-6 border border-[#d4af37]/40 backdrop-blur-sm mb-5 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="relative bg-gradient-to-r from-[#ef4444]/20 via-[#dc2626]/15 to-[#b91c1c]/20 p-5 rounded-2xl border border-[#ef4444]/50 mb-4 overflow-hidden shadow-lg shadow-[#ef4444]/10">
                {/* Confetti background */}
                <div className="absolute inset-0 pointer-events-none z-0">
                  <div className="absolute top-2 left-6 w-2 h-2 bg-[#ef4444] rounded-full animate-pulse"></div>
                  <div className="absolute top-8 right-10 w-1.5 h-1.5 bg-[#dc2626] rounded-full animate-pulse delay-200"></div>
                  <div className="absolute bottom-4 left-10 w-1 h-1 bg-[#b91c1c] rounded-full animate-pulse delay-500"></div>
                  <div className="absolute bottom-6 right-8 w-2 h-2 bg-[#ef4444]/80 rounded-full animate-pulse delay-700"></div>
                </div>
                <div className="flex items-center justify-between relative z-10">
                  <div className="flex items-center gap-4">
                    <div className="text-3xl animate-bounce">📣</div>
                    <div>
                      <div className="font-extrabold text-[#ef4444] text-lg flex items-center gap-2">
                        Instagram Story Reward
                        <span className="text-xl animate-pulse">🏆</span>
                      </div>
                      <div className="text-xs text-[#ffffff] font-semibold bg-[#ef4444]/10 px-2 py-1 rounded-lg inline-block mb-1">
                        Post & tag story selama event, ajak teman dukung tim kamu!
                      </div>
                      <div className="text-[#f5f7fa] text-xs opacity-80">Suporter dengan story terbanyak & kreatif akan menang!</div>
                    </div>
                  </div>
                  <div className="text-right">
                    <div className="font-bold text-[#f5f7fa] text-lg bg-gradient-to-r from-[#ef4444]/80 to-[#b91c1c]/80 px-3 py-1 rounded-xl shadow-md">
                      Rp 100.000
                    </div>
                    <div className="text-[#ef4444] text-xs mt-1 font-semibold">+ Merchandise Eksklusif</div>
                  </div>
                </div>
              </div>
